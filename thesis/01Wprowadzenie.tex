...
Projekt realizowany jest w ramach Software Development Studio (SDS), służącego realizacji projektów informatycznych dla Wydziału Informatyki Politechniki Poznańskiej. W rolę zespołu zarządzającego wcielają się studenci studiów magisterskich (specjalizacja \definicja{Software Engineering}). Zespół programistów tworzą studenci ostatniego semestru studiów inżynierskich, dla których udział w SDS jest ściśle związany z pracą dyplomową inżynierską. Ich wkład w projekt znajduje się w dodatku \ref{Chapter101}. \\
